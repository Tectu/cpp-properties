    ...
    properties
{
    ...
    p_copyable() = default;
    p_copyable(const p_copyable& other) :
        properties(other)
    {
    }
    ...
    properties
{
    ...
    p_movable(p_movable&& other) noexcept = default;

    p_movable& operator=(const p_movable& rhs) = delete;
    p_movable& operator=(p_movable&& rhs) noexcept = delete;
};
...
TEST_SUITE("properties construction")
{
    ...
    TEST_CASE("copy assignment")
    {
        ...
        // Ensure that t1 remained unmodifed
        //REQUIRE_EQ(t1.str, "Hello World!");
        //REQUIRE_EQ(t2.str, "test");
    }
}
